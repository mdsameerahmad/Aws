...
- **CORS:**  
  Configured to allow requests from the frontend (`CLIENT_URL` or `http://65.1.110.115:3000`), with credentials and standard headers.
- **cookieParser:**  
...
CLIENT_URL=http://65.1.110.115:3000
