...
- **CORS:**  
  Configured to allow requests from the frontend (`CLIENT_URL` or `http://13.51.170.85:3000`), with credentials and standard headers.
- **cookieParser:**  
...
CLIENT_URL=http://13.51.170.85:3000
